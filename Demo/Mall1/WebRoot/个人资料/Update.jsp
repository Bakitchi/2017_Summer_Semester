...
<html>
  ...
  <% 
    ...
    String phone=request.getParameter("contact_email");
    String text=request.getParameter("contact_message");
    
    sql.executeUpdate("update user set phone='"+phone+"',text='"+text+"' where uid='"+uname+"'");
