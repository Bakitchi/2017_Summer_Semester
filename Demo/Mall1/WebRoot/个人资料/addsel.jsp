...
<html>
  <head>
    ...
    <title>My JSP 'addsel.jsp' starting page</title>
  ...
  <% 
    ...
    sql.execute("INSERT into dd(sid,uid,num) values('"+ss[i]+"','"+name+"','"+bb[i]+"');");
    sql.executeUpdate("delete from gwc where sid ='"+ss[i]+"'and uid ='"+name+"'");
